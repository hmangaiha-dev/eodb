<template>
  <div class="zcard row items-center q-col-gutter-md">
    <div class="col-12 text-h6 q-pb-none text-center">Form-7</div>
    <p class="col-12 text-caption q-py-none text-center">[See Rule 3(1)]</p>
    <div class="col-12 ztitle text-center">
      APPLICATION FOR RESIDENTIAL LAND SETTLEMENT CERTIFICATE INHMUN/LAND SETTLEMENT CERTIFICATE TURA DILNA
    </div>
