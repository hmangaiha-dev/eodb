  ...
  <div class="zcard row items-center q-gutter-md q-col-gutter-md">
    ...
    <div class="col-xs-12 col-md-1">
      <label class="zlabel" for="dob" type="date"
        >Date Of Establishment Of Workshop/factory<span class="asterisk"
          >*</span
        >
      </label>
    </div>
    ...
    <div class="col-xs-12 col-md-2">
      <label class="zlabel" for="gender"
        >Current Registration Number <span class="asterisk">*</span></label
      >
    </div>
    <div class="col-xs-12 col-md-2">
      <q-input dense outlined />
    ...
    <div class="col-xs-12 col-md-1">
      <label class="zlabel" for="pob">Measuring Instruments With Details</label>
    </div>
    ...
    <div class="col-xs-12 col-md-1">
      <label class="zlabel" for="dob" type="date"
        >Skilled<span class="asterisk">*</span>
      </label>
    </div>
    <div class="col-xs-12 col-md-2">
      <q-input dense outlined />
    ...
    <div class="col-xs-12 col-md-1">
      <label class="zlabel" for="gender"
        >I do hereby affirm that the informations furnished above are true and the documents attached herewith are genuine. <span class="asterisk">*</span></label
      >
    </div>
    <div class="col-xs-12 col-md-2">
      <q-input label="Office" dense outlined />
