	<template>
	  <div class="zcard row items-center q-col-gutter-md">
	    <div class="col-12 text-h6 q-pb-none text-center">Form LD-1</div>
	    <p class="col-12 text-caption q-py-none text-center">SCHEDULE IIA
[See rule 11 (1)]</p>
	    <div class="col-12 ztitle text-center">
	Application Form for Licence as Dealers in Weights & Measures under the
