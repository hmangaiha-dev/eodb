	<template>
	  <div class="zcard row items-center q-col-gutter-md">
	    <div class="col-12 text-h6 q-pb-none text-center">FORM 1(a) </div>
	    <p class="col-12 text-caption q-py-none text-center">[See rules 4(2), 8 (2), 13(2) (ii), 13(2) (vi) and 13(4) (i)] </p>
