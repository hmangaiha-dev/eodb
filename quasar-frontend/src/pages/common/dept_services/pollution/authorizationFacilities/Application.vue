	<template>
	  <div class="zcard row items-center q-col-gutter-md">
	    <div class="col-12 text-h6 q-pb-none text-center">FORM-4</div>
	    <p class="col-12 text-caption q-py-none text-center">[See rules 13(3)(i) and 13(3)(vi)] </p>
	    <div class="col-12 ztitle text-center">
	     APPLICATION FORM FOR AUTHORISATION OF FACILITIES
POSSESSING ENVIRONMENTALLY SOUND MANAGEMENT
PRACTICE FOR DISMANTLING OR RECYCLING OF E-WASTE 
	    </div>
