<template>
  <div class="zcard row items-center q-col-gutter-md">
      ...
      <div class="row justify q-col-gutter-md q-ml-md">
        <div class="col-md-6 col-xs-10">
          ...
          <q-input
            ...
            v-model="formData.pollution_authorization_generation_four_a"
            dense
            outlined
          />
        </div>
        ...
        <div class="col-md-6 col-xs-10">
          ...
          <q-input
            ...
            v-model="formData.pollution_authorization_generation_four_b"
            dense
            outlined
          />
        </div>
        <div class="col-md-6 col-xs-10">
          ...
          <q-input
            ...
            v-model="formData.pollution_authorization_generation_four_c"
            dense
            outlined
          />
        </div>
        ...
        <div class="col-md-6 col-xs-10">
          ...
          <q-input
            ...
            v-model="formData.pollution_authorization_generation_four_d"
            dense
            outlined
          />
        </div>
    ...
    <div class="col-md-6 col-xs-10">
      ...
      <q-input
        :rules="[(val) => (val && val.length > 0) || 'Please type something']"
        v-model="formData.pollution_authorization_generation_five"
        dense
        outlined
      />
    </div>
...
export default {
  setup(props, context) {
    ...
    const formData = reactive({
      ...
      pollution_authorization_generation_three: "",
      pollution_authorization_generation_three_i: false,
      pollution_authorization_generation_three_ii: false,
      pollution_authorization_generation_three_iii: false,
      pollution_authorization_generation_three_iv: false,

      pollution_authorization_generation_four: "",
