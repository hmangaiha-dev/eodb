      ...
      <div class="row justify q-col-gutter-md q-ml-md">
        <div class="col-md-6 col-xs-10">
          ...
          <q-input
            ...
            dense
            outlined
            v-model="formData.pollution_accident_medical_one_a"  :rules="[
    ...
    <div class="col-lg-4 col-sm-6">
      <div class="row justify-end q-col-gutter-md">
        <div class="col-md-6 col-xs-10">
          ...
          <q-file
            v-model="formData.pollution_accident_solid_signature"
            outlined
          >
        ...
        <div class="col-md-6 col-xs-10">
          ...
          <q-input
            v-model="formData.pollution_accident_medical_designation"
            dense
            outlined
          />
        </div>
...
export default {
  setup(props, context) {
    ...
    const formData = reactive({
      ...
      pollution_accident_solid_signature: null,
