	<template>
	  <div class="zcard row items-center q-col-gutter-md">
	    <div class="col-12 text-h6 q-pb-none text-center">FORM – III </div>
	    <p class="col-12 text-caption q-py-none text-center">(See rule 10)</p>
	    <div class="col-12 ztitle text-center">
	     AUTHORISATION
(Authorisation for operating a facility for generation, collection, reception,
treatment, storage, transport and disposal of biomedical wastes) 
	    </div>
