<template>
  <div class="zcard row items-center q-col-gutter-md">
    <div class="col-12 text-h6 q-pb-none text-center">Annexure - IV(A)</div>

    <div class="col-12 ztitle text-center">
      APPLICATION FORM FOR DISCONNECTION OF WATER CONNECTION
    </div>

    <div class="col-12 text-center">(See Section 14 of Act)</div>
