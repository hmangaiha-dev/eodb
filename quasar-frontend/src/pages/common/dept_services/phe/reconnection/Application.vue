<template>
  <div class="zcard row items-center q-col-gutter-md">
    <div class="col-12 text-h6 q-pb-none text-center">Annexure - IV</div>

    <div class="col-12 ztitle text-center">
      APPLICATION FORM FOR RE-CONNECTION OF TEMPORARY DISCONNECTED WATER CONNECTION
    </div>

    <div class="col-12 text-center">(See Rules 7)</div>
