    ...
    <div class="zcard">
      <div class="row q-col-gutter-md">
        <div class="flex justify-between flex-inline col-12">
          <q-btn @click="localData.openCreate=true" outline label="New staff" color="primary"/>
        ...
        <div class="col-12">
          <q-list  separator>
            <q-item v-for="item in localData.listData.data" :key="item.id" >
              <q-item-section>
                <q-item-label>{{item.fullname}} : <span class="text-caption">{{item?.email}}</span></q-item-label>
